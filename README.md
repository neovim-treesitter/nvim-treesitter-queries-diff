# nvim-treesitter-queries-diff

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-diff/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-diff/actions/workflows/validate.yml)

Neovim tree-sitter queries for **diff**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-diff",
...
- [ ] Changes are scoped to `diff` — do not include files for other languages
